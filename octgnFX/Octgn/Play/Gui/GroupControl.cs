...
using Action = Octgn.Script.Action;
...
#pragma warning restore 649
    ...
    protected virtual void OnKeyShortcut(object sender, TableKeyEventArgs e)
    {
      ...
      if (match != null && group.TryToManipulate())
      {
        ...
        if (match.ActionDef.Execute != null)
          ...
          ScriptEngine.Run(match.ActionDef.Actions, group);
    ...
    public void ExecuteDefaultAction(Card card)
    {
      if (defaultCardAction != null)
      {
        ...
        if (defaultCardAction.Execute != null)
          ...
          ScriptEngine.Run(defaultCardAction.Actions, Selection.ExtendToSelection(card));
    ...
    public void ExecuteDefaultAction()
    {
      if (defaultGroupAction != null)
      {
        ...
        if (defaultGroupAction.Execute != null)
          ...
          ScriptEngine.Run(defaultGroupAction.Actions, group);
    ...
    protected virtual void GroupActionClicked(object sender, RoutedEventArgs e)
    {
      ...
      // TODO: remove the old ScriptEngine when compatibility isn't required anymore
      if (action.Execute != null)
        scriptEngine.ExecuteOnGroup(action.Execute, group);
      else
        ScriptEngine.Run(action.Actions, group);
    }

    protected virtual void CardActionClicked(object sender, RoutedEventArgs e)
    {
      ActionDef action = (ActionDef)((MenuItem)sender).Tag;
      // TODO: remove the old ScriptEngine after a few "compatible" releases
      if (action.Execute != null)
        ...
        ScriptEngine.Run(action.Actions, Selection.ExtendToSelection(contextCard));
    }
